...
router.get('/api/v1/allProducts', async function (req, res) {
    try {
...
//get all products
router.get('/api/v1/products', [tokenMiddleware], async function (req, res, next) {
...
router.put('/api/v1/products/:id', [tokenMiddleware], async function (req, res, next) {
    ...
    try {
        ...
        res.status(200).json({
            status: 200,
            message: "อัปเดตข้อมูลสินค้าสําเร็จ",
...
//get product by id
router.get('/api/v1/products/:id', [tokenMiddleware], async function (req, res) {
